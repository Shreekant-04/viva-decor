...
const Section2 = () => {
  ...
  return (
    <section className="w-full py-10 px-6 flex flex-col justify-center items-start gap-4 md:gap-6 lg:gap-8">
      ...
      <div className="w-full flex flex-col md:flex-row flex-wrap justify-center items-center gap-6">
        {data.map((service, i) => (
          <div
            key={i + 1561561}
            className="bg-white p-4 rounded-lg shadow-md flex flex-row w-full md:max-w-[300px] lg:max-w-[400px]  lg:min-h-[150px]  justify-center items-center gap-2"
          >
            <div>
              <img
                src={service.image}
